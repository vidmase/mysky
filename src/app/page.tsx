...
export default function Home() {
  ...
  const stats = {
    ...
    totalCountries: 12,
    totalHours: 187,
    mostVisitedAirport: "LHR - London Heathrow",
    mostUsedAirline: "British Airways",
  }
          ...
          <Card className="shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xl font-semibold">{stats.mostUsedAirline}</div>
                  <div className="text-sm text-muted-foreground">18 flights</div>
                </div>
              </div>
            </CardContent>
          </Card>
          <Card className="shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xl font-semibold">{stats.mostVisitedAirport}</div>
                  <div className="text-sm text-muted-foreground">24 visits</div>
                </div>
              </div>
            </CardContent>
          </Card>
